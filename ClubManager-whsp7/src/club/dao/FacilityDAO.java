...
public interface FacilityDAO {
	 ...
	 * method in it!
	 */
	public abstract Facility createValueObject();
	 ...
	 */
	public abstract Facility getObject(String name)
	 ...
	 */
	public abstract void load(Facility valueObject)
			throws NotFoundException, SQLException;
	 ...
	 * 
	 */
	public abstract List<Facility> loadAll() throws SQLException;
	 ...
	 */
	public abstract void create(Facility valueObject)
			throws SQLException;
	 ...
	 *            Primary-key field must be set for this to work properly.
	 */
	public abstract void save(Facility valueObject)
			throws NotFoundException, SQLException;
	 ...
	 *            Primary-key field must be set for this to work properly.
	 */
	public abstract void delete(Facility valueObject)
			throws NotFoundException, SQLException;
	 ...
	 */
	public abstract List<Facility> searchMatching(Facility valueObject) throws SQLException;

	/**
	 * getDaogenVersion will return information about generator which created
	 * these sources.
	 */
	public abstract String getDaogenVersion();
