CREATE SCHEMA club;
USE club;
CREATE TABLE club.person (
      first_name varchar(255) NOT NULL,
      second_name varchar(255),
      surname varchar(255),
PRIMARY KEY(first_name),
INDEX person_first_name_INDEX (first_name));

INSERT INTO `club`.`person` (`first_name`, `second_name`) VALUES ('Albert', 'Einstien');
INSERT INTO `club`.`person` (`first_name`, `second_name`) VALUES ('Isaac', 'Newton');
INSERT INTO `club`.`person` (`first_name`, `second_name`) VALUES ('Galiloe', 'Galiliei');
INSERT INTO `club`.`person` (`first_name`, `second_name`) VALUES ('Charles', 'Darwin');
INSERT INTO `club`.`person` (`first_name`, `second_name`, `surname`) VALUES ('Thomas', 'Alva', 'Edision');
INSERT INTO `club`.`person` (`first_name`, `second_name`, `surname`) VALUES ('Alexandar', 'Graham', 'Bell');
INSERT INTO `club`.`person` (`first_name`, `second_name`, `surname`) VALUES ('Ludwig', 'Van', 'Beethoven');
INSERT INTO `club`.`person` (`first_name`, `second_name`) VALUES ('John', 'Lennon');
INSERT INTO `club`.`person` (`first_name`, `second_name`, `sur_name`) VALUES ('Leonardo', 'Da', 'Vinci');
INSERT INTO `club`.`person` (`first_name`) VALUES ('Michelangelo');
INSERT INTO `club`.`person` (`first_name`, `second_name`, `sur_name`) VALUES ('Vincent', 'Van', 'Gogh');
INSERT INTO `club`.`person` (`first_name`, `second_name`) VALUES ('Pablo', 'Picasso');


CREATE TABLE club.member (
      member_number bigint AUTO_INCREMENT NOT NULL,
