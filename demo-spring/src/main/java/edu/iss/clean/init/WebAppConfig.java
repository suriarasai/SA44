...
// Web MVC
@EnableWebMvc
// Business classes - Transactions
@EnableTransactionManagement
// Where to look for classes
@ComponentScan(basePackages="edu.iss.caps")
// application properties - Where is my database connectivity details
// messages.properties - JSP formatted messages
@PropertySource({ "classpath:application.properties",
		"classpath:/i18n/messages.properties" })
// JPA
@EnableJpaRepositories("edu.iss.caps.repository")
